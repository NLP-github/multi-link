...
function App() {
  ...
  const links = [
    ...
    {url: "https://ya.ru/", icon: FaGlobe, text: "Мой Сайт"},
    {url: "https://github.com/NLP-github", icon: AiFillGithub, text: "Мой GitHub"},
    {url: "https://t.me/N_LP0", icon: FaTelegram, text: "Группа Telegram"},
    {url: "https://boosty.to", icon: AiFillDollarCircle, text: "Поддержать канал"},
    {url: "https://dzen.ru", icon: FaGlobe, text: "ДЗЕН"},
    {url: "https://rutube.ru", icon: FaGlobe, text: "Rutube"},
    {url: "https://www.tiktok.com", icon: FaGlobe, text: "TikTok"},
  ]

    //Ссылки на доп. материалы
    const devlinks = [
      {url: "https://github.com/", icon: AiFillGithub, text: "Github"},
      {url: "https://github.com/", icon: AiFillGithub, text: "Github"},
      {url: "https://", icon: FaYoutube, text: "Настрой свой ..."},
      {url: "https://", icon: FaYoutube, text: "Telegram бот с GPT"},
    ]
